...
onready var MisileExplosion = preload("res://game/projectiles/MisileExplosionParticles.tscn")
onready var MisileTrail = preload("res://game/projectiles/MisileTrail.tscn")
onready var DropParticles = preload("res://game/projectiles/MisileDropParticles.tscn")
