...
var game_drivers_data: Dictionary = { # shranjuje se v current_game_drivers_data
	#	"xavier": {
	#		"vehicle_profile": {}
	#		"driver_profile": {}
...
func set_game(new_level_index: int): # kliče main po spawnu
	...
	game_drivers_data = Sets.current_game_drivers_data # nedupliciran, da je skos apdejtan
