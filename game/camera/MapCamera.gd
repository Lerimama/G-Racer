...
func _process(delta: float) -> void:
	pass
	if Ref.current_camera and Ref.current_camera.follow_target:
		position = Ref.current_camera.follow_target.global_position
...
#		if new_follow_target.is_in_group(Ref.group_bolts) or Ref.game_manager.game_on: # RFK ... kamera - hitrost setanja poizicije 
