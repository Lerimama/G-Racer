...
var points_separation: int = 320 # pixli med sosednjimi točkami grida
...
func get_navigation_points(): # ai na SEARCH state ... samo prvič

	var nav_positions_density: float = get_viewport_rect().size.x / points_separation
...
func _update_navigation_path(start_position: Vector2, end_position: Vector2): # debug ... samo za mouseclick target
