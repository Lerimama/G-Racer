...
func set_scoretable(drivers_data: Dictionary, for_summary: bool):
	...
	if for_summary:
		...
		update_scorelines_for_level(drivers_data)
...
func update_scorelines_for_level(drivers_data: Dictionary):
