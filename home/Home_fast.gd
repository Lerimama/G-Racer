...
##	Met.switch_to_scene("res://game/Game.tscn")
...
#		"start_game":
#
#			print("Pro.arena_tilemap_profiles------------------------------")
#			# trenutna mapa
...
#			switch_to_scene("res://game/arena/Arena.tscn", current_used_cells) # 2. arg je zato, da jih zbrišemo
#
#
...
#	var new_arena_cells: Array = Pro.arena_tilemap_profiles[arena_save_name]
