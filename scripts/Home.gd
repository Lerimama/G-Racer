...
#
##play
#onready var play1_confirm_btn: Button = $UI/Play/ItemList/thumb/ConfirmBtn
#onready var play2_confirm_btn: Button = $UI/Play/ItemList/thumb2/ConfirmBtn
#onready var play3_confirm_btn: Button = $UI/Play/ItemList/thumb3/ConfirmBtn
#onready var play4_confirm_btn: Button = $UI/Play/ItemList/thumb4/ConfirmBtn
#onready var play_back_btn: Button = $UI/Play/BackBtn
#
## players
#onready var players1_confirm_btn: Button = $UI/Players/ItemList/thumb/ConfirmBtn
#onready var players2_confirm_btn: Button = $UI/Players/ItemList/thumb2/ConfirmBtn
#onready var players3_confirm_btn: Button = $UI/Players/ItemList/thumb3/ConfirmBtn
#onready var players4_confirm_btn: Button = $UI/Players/ItemList/thumb4/ConfirmBtn
