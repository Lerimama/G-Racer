...
# player
var player_index: int # ga dobi iz spawnerja, glede na vrstni red kreacije
...
var axis_distance: float # širina teksture, ki se seta v ready 
...
# controller
var controller_profile_name: String # ime kontroler profila se pošlje od spawnerja
var controller_profile: Dictionary
var controller_actions: Dictionary
var fwd_action # dobi ime akcije it InputMap 
var rev_action
var left_action
var right_action
var shoot_bullet_action
var shoot_misile_action
var shoot_shocker_action
...
#				new_bullet.global_position = bolt_sprite.global_position# + gun_pos
		...
		"Shield":		
			if shields_on == false:
				...
				# collisions setup in shields_on = false je premaknjeno dol na konec animacije
