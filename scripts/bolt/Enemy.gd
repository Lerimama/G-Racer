...
# enemy profil
onready var aim_time = Profiles.enemy_profile["aim_time"]
onready var seek_rotation_range = Profiles.enemy_profile["seek_rotation_range"]
onready var seek_rotation_speed = Profiles.enemy_profile["seek_rotation_speed"]
onready var seek_distance = Profiles.enemy_profile["seek_distance"]
onready var engine_power_idle = Profiles.enemy_profile["engine_power_idle"]
onready var engine_power_battle = Profiles.enemy_profile["engine_power_battle"]
onready var shooting_ability = Profiles.enemy_profile["shooting_ability"]
