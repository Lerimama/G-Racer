...
#var current_motion: int = MOTION.STILL
#
...
##onready var BreakerChunk: PackedScene = preload("res://breaker/BreakerChunk.tscn")
...
#	broken_shape.hide()
#
##	printt("BR", name, global_position, position)
#
#
#
#
...
#					break
#			var indi = Mets.spawn_indikator(hit_global_position)
#			var indi1 = Mets.spawn_indikator(hit_vector[0])
#			var indi2 = Mets.spawn_indikator(hit_vector[1])
#
...
#
#
#func spawn_new_breaker(new_braker_polygon: PoolVector2Array, new_color: Color = Color.white):
#
#
#
