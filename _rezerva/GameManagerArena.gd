...
#	if Set.default_game_settings["enemies_mode"]: # začasno vezano na Set. filet
...
#
#	if level_goal_reached and current_level_index < (Set.game_levels.size()):
...
#
#	# level name
#	var level_to_load: int = Set.current_game_levels[current_level_index]
#	# level settings
#	level_settings = Set.level_settings[level_to_load]
##	printt("sett", level_settings, Set.level_settings[level_to_load])
#	var level_scene_to_load: PackedScene = level_settings["level_scene"]
...
#	printt("level_to_load_path", level_to_load_path, level_settings)
#
...
##	var new_level = level_scene_to_load.instance()
...
#
#	if Set.default_game_settings["enemies_mode"]:
