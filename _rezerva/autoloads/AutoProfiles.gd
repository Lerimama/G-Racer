...
var pickable_profiles: Dictionary = {
	...
	0: { # BULLET
		"path": preload("res://game/pickables/PickableBullet.res"),
		"amount": 20,
	},
	1: { # MISILE
		"path": preload("res://game/pickables/PickableMisile.res"),
		"amount": 2,
	}, 
	2: { # SHOCKER
		"path": preload("res://game/pickables/PickableShocker.res"),
		"amount": 1,
	}, 
	3: { # SHIELD
		"path": preload("res://game/pickables/PickableShield.res"),
		"amount": 0,
	},
	4: { # ENERGY
		"path": preload("res://game/pickables/PickableEnergy.res"),
		"amount": 0,
	},
	5: { # LIFE
		"path": preload("res://game/pickables/PickableLife.res"),
		"amount": 1,
	},
	6: { # NITRO
		"path": preload("res://game/pickables/PickableNitro.res"),
		"amount": 500,
	},
	7: { # TRACKING
		"path": preload("res://game/pickables/PickableTracking.res"),
		"amount": 0.7,
	},
	8: { # RANDOM
		"path": preload("res://game/pickables/PickableRandom.res"),
